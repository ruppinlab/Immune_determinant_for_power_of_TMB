...
Panel3 <- ggplot(df2plot_pearson, aes(x=effect_size, y= abundance, size= -log(P, 10))) + 
  ...
  ggsave('/Users/neelamf2/Documents/GitHub/Immune_determinant_for_power_of_TMB/Result_fgures/OS_Power_of_TMB_in_5_abu_modulators_spear.pdf',
         Panel3, height=10, width = 9, units = 'in', dpi = 500)
...
panel4=ggplot(MeanCorr_df, aes(x=ORR, y=durable_response, label=mod_labels))+
...
ggsave('/Users/neelamf2/Documents/GitHub/Immune_determinant_for_power_of_TMB/Result_fgures/Panel_2_C.pdf', panel4, height=4, width = 4, units = 'in', dpi = 500)
