...
```
<!--Run the Analysis 2 using 10 percentile-->
<!--training and testing data preprocessing-->
```{r}
### DF: Power of TMB with variable, measure by OS
...
<!--Run the Analysis 3 using 20 percentile-->
<!--training and testing data preprocessing-->
```{r}
### DF: Power of TMB with variable, measure by OS
...
<!--Run the Analysis 4 using same number of sample, which we get using th >= 10 mut/MB-->
<!--training and testing data preprocessing-->
```{r}
### DF: Power of TMB with variable, measure by OS
